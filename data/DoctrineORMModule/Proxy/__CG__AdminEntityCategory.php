 ...
 */
class Category extends \Admin\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Admin\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Admin\\Entity\\Category' . "\0" . 'categoryName');
        }
